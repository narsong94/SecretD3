...
<body>
	...
	<div class="content-container">
		<div id="id-find-form">
			...
			<a href="../login"><input type="button" class="btn btn-default btn-pad" value="로그인 하기" /></a> <a
				href="../id/find-pw"><input type="button" class="btn btn-default btn-pad" value="비밀번호 찾기" /></a>
			</div>
		</div>
	</div>
	</main>

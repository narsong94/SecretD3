	...
	<div class="content-container">
		...
		<div id="notice-header">
			...
			<div id="head-main-menu" class="hr-list head-main-menu">
				...
				<ul>
					<li><a id="select-survey" href="${path}/guest/survey/index">자가진단</a></li>
					<li><a id="select-disease" href="${path}/guest/search/list">질병검색</a></li>
					<li><a id="select-counseling" href="${path}/guest/counseling/list">고민상담</a></li>
					<li><a id="select-notice" href="${path}/guest/faq/list">공지사항</a></li>
				</ul>
			</div>
		</div>
	</div>
